...
For uses: It provides a message telling that it didn’t understand the question.
...
Download the knowledge base JSONs files for the desired languages (e.g., knowledge_base_cat.json, knowledge_base_esp.json, or knowledge_base_eng.json).
...
The new answer will be added to the knowledge base for future use.
For the user mode, this is replaced by a: “ No te he entendido, formula nuevamente la pregunta de una forma distinta”.
